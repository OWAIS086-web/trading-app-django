...
urlpatterns = [
    ...
    path('admin_change-password/', auth_views.PasswordChangeView.as_view(), name='admin_password_change'),
    path('admin-password-changed/', views.password_change_done, name='admin_password_change_done'),
    ...
    path('get_social_account_data/', views.get_social_account_data, name='get_social_account_data'),
